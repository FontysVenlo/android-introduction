...
*  ⚠️ How to put your local code into github, see: [import existing android app to github](https://github.com/FontysVenlo/android-introduction/blob/master/docs/import-existing-android-app-2-github/text.md)
